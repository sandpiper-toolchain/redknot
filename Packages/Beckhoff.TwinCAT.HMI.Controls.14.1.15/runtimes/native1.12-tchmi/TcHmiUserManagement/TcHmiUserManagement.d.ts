...
declare namespace TcHmi.Controls.Beckhoff.TcHmiUserManagementPopups {
    ...
    class EditUserPopup extends Popup {
        ...
        /** Input event destroyers */
        protected __inputEventDestroyer: DestroyFunction[];
        /**
         * Shows the popup.
         */
        show(): void;
...
declare namespace TcHmi.Controls.Beckhoff.TcHmiUserManagementPopups {
    ...
    class AddUserPopup extends Popup {
        ...
        protected __forcePasswordChangeCheckbox: TcHmi.Controls.Beckhoff.TcHmiCheckbox | undefined;
...
declare namespace TcHmi.Controls.Beckhoff.TcHmiUserManagementPopups {
    ...
    class ChangeUserPopup extends Popup {
        ...
        /**content 3 html element*/
        protected __elementContent_3: HTMLElement;
        /**dropdown eventhandler for group element scroll*/
        protected readonly __evtHandlerGroupScroll: (this: void, e: MouseEvent) => void;
        /**confirm button*/
        protected __confirmButton: TcHmi.Controls.Beckhoff.TcHmiButton | undefined;
        ...
        protected __updatePopupControls(): void;
        /**
         * Creates the password options.
         */
        protected __createPasswordInfo(): void;
        /**
...
declare namespace TcHmi.Controls.Beckhoff.TcHmiUserManagementPopups {
    class PasswordRequirements extends HTMLElement {
        ...
        protected __customRules: Map<string, string>;
        ...
        /**event destroyer functions */
        protected __eventDestroyers: DestroyFunction[];
        constructor(parentControl: TcHmi.Controls.Beckhoff.TcHmiUserManagement, customRules?: Map<string, string>, initCallback?: () => void);
