declare namespace TcHmi.Controls.Helpers {
    class Banner {
         ...
         */
        constructor(targetElement: HTMLElement, __parentControl?: System.TcHmiControl | null | undefined);
        /**
...
declare namespace TcHmi.Controls.Helpers {
    class ApprovalBanner extends Banner {
         ...
         * @param __parentControl The control which owns the Banner.
         */
        constructor(targetElement: HTMLElement, storageId: string | null, __parentControl?: System.TcHmiControl | null | undefined);
        show(): void;
        /**
